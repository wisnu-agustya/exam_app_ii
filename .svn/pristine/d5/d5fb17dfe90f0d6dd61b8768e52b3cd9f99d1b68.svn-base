	...
	<div class="col-md-12">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#add_user" type="button"><i class="fa fa-plus"></i>Add User</button><br><br>
...
<script>
	$(document).ready(function(){
		...
		var rowid = $(e.relatedTarget).data('id');
			$.ajax({
				type : 'get',
			  url  : 'view_admin/7_edit_user.php', //Here you will fetch records 
	...
	$(document).ready(function(){
		$('#delete_user').on('show.bs.modal', function (e) {
			var rowid = $(e.relatedTarget).data('id');
				$.ajax({
				type : 'get',
				url	 : 'view_admin/7_delete_user.php', //Here you will fetch records 
				data : 'id='+ rowid, //Pass $id
			  success : function(data){
			  	$('.fetched-data').html(data);//Show fetched data from database
			  }
	...
	$(document).ready(function(){
		$('#view_user').on('show.bs.modal', function (e) {
			var rowid = $(e.relatedTarget).data('id');
				$.ajax({
				type : 'get',
				url  : 'view_admin/7_detail_user.php', //Here you will fetch records 
				data : 'id='+ rowid, //Pass $id
			  success : function(data){
			  	$('.fetched-data').html(data);//Show fetched data from database
			  }
