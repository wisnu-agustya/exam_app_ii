      ...
      <div class="panel-body">
              ...
              <table class="table table-xs" id="tbExam">
                ...
                while($row = mysqli_fetch_array($result)){
                  ...
                  $dataParticpant = mysqli_num_rows(listExamParticipants($row[7]));
                  echo '
                  <tr>
                    <td>'.$no.'</td>
                    ...
                    if ($row[5]!='init') {
                      ...
                      if ($view[2] == 'true') {
                        echo '<a href="?pg=pic_result_detail&CC='.$row[0].'"><button type="button" class="btn btn-xs btn-primary"><i class="fa fa-search-plus"></i>  View</button></a> ';
                      }else{
