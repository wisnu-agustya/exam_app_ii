...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><a href="?pg=ExA_exam_schedule" class="btn btn-xs btn-danger"><i class="fa fa-arrow-left"></i> Back</a> &nbspSchedule</div>
...
<script>
	$(document).ready(function(){
      ...
      $.ajax({
        type : 'GET',
        url  : 'view_exam_admin/1_pic_datastarted.php', //Here you will fetch records 
        data : {id:id},   //Pass $id
...
<script>
	$(document).ready(function(){
      ...
      $.ajax({
        type : 'GET',
        url  : 'view_exam_admin/1_pic_dataparticipant.php', //Here you will fetch records 
        data : {id:idg},   //Pass $id
        success : function(data){
          $('#output').html(data);
        }
