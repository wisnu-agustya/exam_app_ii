...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#add_cust" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Add Customer</button><br><br>
