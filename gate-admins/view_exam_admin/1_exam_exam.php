                ...
                while($row = mysqli_fetch_array($result)){
                  if ($row[4]!=null) {
                    ...
                    if (cekTimeSchedule($row[0])) {
                      $token="<a href=\"?pg=ExA_exam&CC=".$row[0]. "\"><button type=\"button\" class=\"btn btn-xs btn-danger  btn-block\"><i class=\"fa fa-key\"></i>  Generate</button></a>";
                    } else {
                    ...
                    <div class=\"panel panel-info\" style=\"border: 1px solid #30a5ff;\">
                      ...
                      <div class=\"panel-body\" style=\"text-align:center\">
                        ...
                        if($row[3]==0){
                          ...
                          echo "<button type=\"button\" class=\"btn btn-block btn-sm btn-default\">Use</a>";
                          }
                        }else {
                          echo "<a href=\"?pg=ExA_create&CC=".$row[0]."\" class=\"btn btn-block btn-sm btn-danger\">Use</a>";
                        } 
                      echo "<a href=\"?pg=ExA_detail_voucher&id=".$row[0]."\" class=\"btn btn-block btn-sm btn-success\">View</a>";
                      echo"
                      </div>
                    </div>
                  </div>";
