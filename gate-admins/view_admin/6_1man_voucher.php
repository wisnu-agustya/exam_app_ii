	...
	<div class="col-md-12">
		<div class="panel panel-info">
			...
			<div class="panel-body">
			    <a href="?pg=admin_man_cust"><button class="btn btn-xs btn-danger"><i class="fa fa-arrow-left" ></i> Back</button></a>
				<button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#add_cust" type="button"><i class="fa fa-plus"></i> Create Programs</button><br><br>
						...
						<?php
							...
							while($row = mysqli_fetch_array($result)){
								...
								<tr>
									...
									<td>'.$row[3].'</td>
									<td>
									<a href ="?pg=detail_voucher&id='.$row[0].'" class="btn btn-xs btn-info "> <i class="fa fa-table"></i>  Stock Card</a> &nbsp
									<a href ="?pg=approve_remidial&id_cust='.$id.'&prog='.$row[5].'" class="btn btn-xs btn-success "> <i class="fa fa-check-square-o"></i>  Approve Remidial</a> &nbsp
